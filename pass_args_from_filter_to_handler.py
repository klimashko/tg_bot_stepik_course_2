...
BOT_TOKEN = '5098264915:AAFgUTLIuVr-qVoorGFYL9BOKf9w68s0RRw'
...
# Будем считать, что числа целые неотрицательные,
# стоят в окружении пробелов или могут заканчиваться на точку или запятую. Чтобы не усложнять задачу.
